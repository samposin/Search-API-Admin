...
// High Volume Website Report list through datatable logic
var HighVolumeWebsiteReportListDataTableAjax = function (){
	...
	var handleRecords = function (){
		...
		grid.init({
			...
			dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options
				...
				"ajax": {
					"url": "high-volume-website-ajax", // ajax source
					"method": "post",
		...
		// handle export drop down item click
		 ...
		 jQuery('#export_dropdown').on('click', 'li a', function (e) {
...
jQuery(document).ready(function (){
	...
	HighVolumeWebsiteReportListDataTableAjax.init();
