                        ...
                        <div class="col-md-12">
                            <div class="portlet light">
                                <div class="portlet-title tabbable-line">
                                    <div class="caption caption-md">
                                        <i class="icon-equalizer font-blue-madison"></i>
                                        <span class="caption-subject font-blue-madison bold uppercase">Advertisers - Search defaults</span>
                                    </div>
                                    <div class="actions">
                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="datatable_ajax">
                                            ...
                                            <tbody>
                                                 ...
                                                 <tr>
                                                     ...
                                                     <td>
                                                         <select data-publisher-id="{{$publisher_id}}" data-geo="{{$k}}" data-api-priority="main"  name="main_api[]" class="form-control">
                                                            <option value="">Select...</option>
                                                            @if(count($v))
                                                                @foreach($v as $api)
                                                                    @if(isset($advertiser_publisher_search_defaults_arr[$k]['main']) && $advertiser_publisher_search_defaults_arr[$k]['main']==$api['api_name'])
                                                     ...
                                                     <td>
                                                         <select data-publisher-id="{{$publisher_id}}" data-geo="{{$k}}" data-api-priority="first"   name="first_backfill_api[]"  class="form-control">
                                                            <option value="">Select...</option>
                                                            @if(count($v))
                                                                @foreach($v as $api)
                                                                    @if(isset($advertiser_publisher_search_defaults_arr[$k]['first']) && $advertiser_publisher_search_defaults_arr[$k]['first']==$api['api_name'])
                                                                    <option value="{{$api['api_name']}}" selected="selected">{{$api['api_display_name']}}</option>
                                                                    @else
                                                                    <option value="{{$api['api_name']}}">{{$api['api_display_name']}}</option>
                                                                    @endif
                                                     ...
                                                     <td>
                                                         <select  data-publisher-id="{{$publisher_id}}" data-geo="{{$k}}" data-api-priority="second"  name="second_backfill_api[]" class="form-control">
                                                            <option value="">Select...</option>
                                                            @if(count($v))
                                                                @foreach($v as $api)
                                                                    @if(isset($advertiser_publisher_search_defaults_arr[$k]['second']) && $advertiser_publisher_search_defaults_arr[$k]['second']==$api['api_name'])
                                                                    <option value="{{$api['api_name']}}" selected="selected">{{$api['api_display_name']}}</option>
                                                                    @else
                                                                    <option value="{{$api['api_name']}}">{{$api['api_display_name']}}</option>
                                                                    @endif
...
@section('footer')
    <script language="JavaScript" type="text/javascript">
        ...
        var publisher_search_defaults_submit_url='{{url('admin/')}}/publishers/advertiser-search-defaults'
