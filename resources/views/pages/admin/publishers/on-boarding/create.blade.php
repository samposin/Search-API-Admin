    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="profile-content">
                <form action="{{url('admin/publishers')}}" class="form-horizontal" name="frm_publisher_edit" id="frm_publisher_edit" method="post" novalidate="novalidate">
                    <div class="row">
                        <div class="col-md-12">
                            {!! csrf_field() !!}
                            <div class="portlet light">
                                        ...
                                        <div class="error_class_div">
                                            ...
                                            <div class="col-md-4">
                                                <div >
                                                    ...
                                                    <span class="help-block"><i>enter email id to send reports</i></span>
                                                </div>
                                    ...
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            @if(count($advertisers))
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="col-xs-12">{{$advertiser->name}}</div>
                                                    </td>
                                                    <td>
                                                        <div class="col-xs-8">
                                                            <input type="text" class="form-control" name="publisher_id1s[]"  value="">
                                                            <input type="hidden" class="form-control" name="advertizer_ids[]"  value="{{$advertiser->id}}">
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="col-xs-6">
                                                            <div >
                                                                <div class="input-inline input-medium">
                                                                    <input id="share" class="cls_publisher_share" type="text" value="0.00"  name="shares[]" class="form-control">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </td>
