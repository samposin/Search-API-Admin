...
@section('footer')
    <script language="JavaScript" type="text/javascript">
        ...
        var url_dashboard_api_ajax='{{url('admin/csv-report/api')}}';
        var  url_dashboard_csv_download_ajax='{{url('admin/csv-report/download')}}';
        var  url_dashboard_csv_email_send_ajax='{{url('admin/csv-report/email_send')}}';
    </script>
    <script src="{{ URL::asset('pages/scripts/admin/csv-report.js')}}"></script>
@stop