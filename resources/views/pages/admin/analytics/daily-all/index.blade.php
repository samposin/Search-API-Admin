...
@section('title', 'Analytics - Clicks Per day')
...
@section('page_level_styles')
    ...
    <link  type="text/css" href="{{ URL::asset('assets/global/plugins/amcharts/amcharts/plugins/export/export.css')}}" rel="stylesheet">
@stop
            ...
            <div class="portlet light">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-blue-sharp bold uppercase">Clicks Per day</span>
                    </div>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-1">
                                <div class="form-group">
                                    ...
                                    <button  class="btn blue btn_daily_ajax" type="button">Show</button>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                                ...
                                <div class="graph-show-data">
                                    ...
                                    <div class="portlet box yellow">
                                        ...
                                        <div class="portlet-body">
                                            ...
                                            <div id="chart_1" class="chart" style="height: 600px;">
                                            </div>
                                        </div>
                                    </div>
                                    <!-- END CHART PORTLET-->
...
@section('page_level_plugins')
    ...
    <script type="text/javascript" src="{{ URL::asset('assets/global/plugins/amcharts/amcharts/plugins/export/export.min.js')}}"></script>
@stop
...
@section('footer')
    <script language="JavaScript" type="text/javascript">
        ...
        var url_analytics_daily_all_ajax='{{url('admin/analytics/daily-all-ajax')}}';
        var url_amchart_export_lib='{{ URL::asset('assets/global/plugins/amcharts/amcharts/plugins/export/libs/')}}/';

    </script>
    <script src="{{ URL::asset('pages/scripts/admin/analytics-daily-all.js')}}"></script>
@stop