    ...
    <div class="row">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <select id="group-by" name="group-by" class="form-control">
                                        ...
                                        <option value="jsver">jsver</option>
                                ...
                                <div class="graph-show-data">
                                    ...
                                    <div class="portlet box yellow">
                                        ...
                                        <div class="portlet-body">
                                            ...
                                            <div class="text-center graph-no-data-found"><h3 class="text-danger">No Record Found</h3></div>
        ...
        @section('footer')
            <script language="JavaScript" type="text/javascript">
                ...
                var url_analytics_hourly_jsver_graph_ajax='{{url('admin/analytics/hourly/jsver/graph-ajax')}}';
            </script>
            <script src="{{ URL::asset('pages/scripts/admin/hourly-jsver/analytics-hourly-jsver-graph.js')}}"></script>
