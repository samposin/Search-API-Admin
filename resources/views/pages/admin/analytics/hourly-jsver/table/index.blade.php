    ...
    <div class="row">
        ...
        @section('footer')
            <script language="JavaScript" type="text/javascript">
                ...
                var url_analytics_hourly_jsver_table_ajax='{{url('admin/analytics/hourly/jsver/table-ajax')}}';
            </script>
            <script src="{{ URL::asset('pages/scripts/admin/hourly-jsver/analytics-hourly-jsver-table.js')}}"></script>
